...
# API Key
api_key = st.sidebar.text_input("OpenAI API Key", value="", type="password", key=None)
# Select Model
model = st.sidebar.selectbox("Select Model", options=["gpt-3.5-turbo-0125", "gpt-3.5-turbo", "gpt-4-0125-preview", "gpt-4-turbo"], key=None)
...
disable_generate = (result is None) | (result.empty) | (api_key == "") | (model == "")
